...
#
# Installerer en macOS Quick Action (Automator-tjeneste) som lar deg
# høyreklikke på en fil i Finder og velge «Skann med XLENT».
#
# Bruk:
#   bash scripts/install_mac_service.sh
#
# Krever at XLENTScanner.app er installert i /Applications.
# Etter installasjon: logg ut og inn igjen (eller kjør: killall Finder)
# for at tjenesten skal dukke opp i høyreklikk-menyen.
...
# Sett inn riktig binær-sti
sed -i.bak "s|\${APP_BINARY}|${BINARY}|g" "$SERVICE_PATH/Contents/document.wflow"
rm -f "$SERVICE_PATH/Contents/document.wflow.bak"
...
echo ""
echo "For å aktivere høyreklikk-menyen:"
echo "  1. Logg ut og inn igjen, eller kjør: killall Finder"
echo "  2. Høyreklikk en fil i Finder → Hurtighandlinger → Skann med XLENT"
